class BookingList
  ...
  def add(booking)
    result = @database.run("INSERT INTO bookings
    (username, start_date, end_date, property_id) VALUES ($1, $2, $3, $4) RETURNING id;",
  ...
  def update(index, username, start_date, end_date, property_id)
    @database.run("UPDATE bookings
    SET username = $2, start_date = $3, end_date = $4, property_id = $5 WHERE id = $1;",
